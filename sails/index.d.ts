// Type definitions for sails 0.12
// Project: http://sailsjs.org
// Definitions by: Jimmy Cann <https://github.com/yjimk>
// Definitions: https://github.com/DefinitelyTyped/DefinitelyTyped
// Typings forked and modified from Ben Teichman's (https://github.com/effervescentia) repo "typed-sails" (https://github.com/effervescentia/typed-sails)
...
declare namespace sails {
  ...
  interface Sails extends EventEmitter {
    ...
    after(event: string, listener: () => void): this;
  }
  ...
  interface SocketClient {
    off(identity: string, handler: () => void): void;
    post(url: string, data?: any, handler?: (data: any, jwres: SocketResponse) => void): void;
    on(identity: string, handler: () => void): void;
  ...
  interface Model {
    save(cb: (err?: Error) => void): Promise<Result> | void;

    count(criteria?: number | string | any, cb?: (err: Error, count: number) => void): Promise<number>;

    create(params: any, cb?: (err: Error, created: Result) => void): Promise<Result>;
    create(params: any[], cb?: (err: Error, created: Result[]) => void): Promise<Result[]>;

    destroy(criteria: any, cb?: (err?: Error) => void): Promise<Record[]>;

    find(): QueryBuilder;

    find(criteria: any, cb?: (err: Error, found: Result[]) => void): Promise<Result>;

    findOne(criteria: any, cb?: (err: Error, found?: Result) => void): Promise<Result>;

    findOrCreate(criteria: any | any[], params: any | any[], cb?: (err: Error, createdOrFound?: Result | Result[]) => void): Promise<Result | Result[]>;

    /**
     * @sql
     */
    query(criteria: string, cb?: (err: Error, found: Result[]) => void): Promise<Result[]>;

    stream(criteria: any, overrides?: { end: () => void, write: () => void }): Stream.Writable;

    update(criteria: any | any[], updates: any | any[], cb?: (err: Error, updated: any[]) => void): Promise<Result[]>;
  ...
  interface QueryResult extends Record {
    toJSON(): any;
    save(cb?: (err: Error, savedRecord: any) => void): Promise<any>;
  ...
  namespace Config {
    ...
    interface Sockets {
       ...
       * @type {Function}
       */
      afterDisconnect(session: any, socket: any, cb: () => void): void;
      /**
       ...
       * @type {boolean}
       */
      beforeConnect: (handshake: any, cb: () => void) => void | boolean;
      /**
       * This is a raw configuration option exposed from Engine.io. It indicates
